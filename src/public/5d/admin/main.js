...
function callListOrder() {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (game == 1)
        $("#Result").text("Next Result: " + `${settings.k5d == "-1" ? "Random" : settings.k5d}`);
      if (game == 3)
        $("#Result").text("Next Result: " + `${settings.k5d3 == "-1" ? "Random" : settings.k5d3}`);
      if (game == 5)
        $("#Result").text("Next Result: " + `${settings.k5d5 == "-1" ? "Random" : settings.k5d5}`);
      if (game == 10)
        $("#Result").text(
          "Next Result: " + `${settings.k5d10 == "-1" ? "Random" : settings.k5d10}`,
        );
