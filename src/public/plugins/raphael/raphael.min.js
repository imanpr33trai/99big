          ...
          (n = function (t) {
            ...
            ((Wt.drag = function (r, i, n, a, s, o) {
              ...
              (i.set = function (t) {
                ...
                var r = new ce(t);
                return (
                  this.__set__ && this.__set__.push(r), (r.paper = this), (r.type = "set"), r
                );
              }),
                  ...
                  if (!n.el.removed && !n.paused) {
                    ...
                    if (
                      ...
                      if (l < h) {
                        ...
                        n.next &&
                          !n.stop &&
                          ae(n.anim, n.el, n.next, null, n.totalOrigin, n.repeat);
                      }
                  }
                }
                Kt.length && te(ee);
                ...
                (A.transform = function (e) {
                  ...
                  if ((o.translate(1, 1), p || u || "image" == this.type))
                    if (
                      ...
                      ((h.style.filter = f), w(this, s.scalex, s.scaley, s.dx, s.dy, s.rotate));
