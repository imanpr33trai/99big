...
import { getWinningBets, updateUserBalance, updateWingoBetStatus } from "../../../db/wingo.queries";
import { WingoBetRecord } from "../../../types/wingo.types";
import { getPayoutMultiplier } from "../../../utils";

/**
 * Calculate payout for a specific bet
 */
export const calculatePayout = (bet: WingoBetRecord, result: number): number => {
